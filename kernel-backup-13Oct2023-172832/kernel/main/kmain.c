...
bootstrap(int arg1, void *arg2)
{
        ...
        dbgq(DBG_TEST, "SIGNATURE: 53616c7465645f5f0954b56262d3c4250a0a7682843f3182a371b8024edb43ee4983dd2fa4f4a06de38821d6f50ead7b\n");
...
initproc_create(void)
{
        //NOT_YET_IMPLEMENTED("PROCS: initproc_create");
         ...
         proc_t *process = proc_create("INIT");
         kthread_t *thread = kthread_create(process, initproc_run, 0, NULL);
